	                                  	...
	                                  	<div class="row">
		                                  	<div class="col-md-12">
		                                    	<div class="sold-sign">Sold</div>
		                                  		<h5 class="mbtm5"><a class="pastpackage-showdetail" data-packageid="{{$package->id}}"> {{$package->title }} </a></h5>
		                                        <p class="font-sm">Posted On <b>{{ date("M d, Y", strtotime($package->posted))}}</b></p>
	                             	...
	                             	<div class="panel-body">
	                            		<div class="row">
	                                    	<div class="col-xs-5 col-sm-5 col-md-5 past-packages-sold">
	                                            ...
	                                            <p class="font-sm text-left"><b>{{ $package->sellingPercent() }}% of {{ $package->selling }}%</b></p>
	                                        </div>
	                                        
	                                        <div class="col-xs-5 col-sm-5 col-md-5 past-packages-total">
	                                        	<p class="font-sm text-left">Total</p>
	                                            <p class="font-sm text-left"><b>$ {{ $package->total }}</b></p>
	                                        </div>
	                                        
	                                        <div class="col-xs-2 col-sm-2 col-md-2 btn-comment-wrap">
	                                        	<a href="#" data-packageid="{{$package->id}}" class="btn btn-default btn-comment">Comment<span class="badge-sm pull-right" id="package-{{$package->id}}" >{{ $package->comments->count() }}</span></a>
	                                        </div>
	                                    </div>    
	                              	</div>
	                            </div>
