				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<span class="button-checkbox">
	                        ...
	                        <label for="terms_and_conditions" class="checkbox-label"><span>By clicking Register, you agree to the</span> <a href="{{ url('/termsandcondition')}}" data-toggle="modal">Terms and Conditions</a></label>
						</span>
					</div>
