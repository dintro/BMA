...
Route::get('/{query?}', array('as' => 'searchPackageHome', 'uses' => 'HomeController@showHome'));
...
Route::post('/message/ajax/refreshMessageNotification', function()
{
    ...
    //     $messageArray = array_fill(0, $messages->count(), null);
    //     $i = 0;
    //     foreach ($messages as $message) {

    //         $messageArray[$i] = $arrayName = array(
    //                                                 'message' => $message->preview(),
    //                                                 'url' => url('/message/'.$message->user->id),
    //                                                 'fullname' => $message->user->getFullname(),
...
Route::post('packs/cancel/{$id}', function($id)
{
...
Route::delete('/canceluserblock', 'UserblockController@canceluserblock');
