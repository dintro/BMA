...
class DailyGenerator extends Command {
	...
	public function fire()
	{
        ...
        $yesterday = date("Y-m-d", strtotime(date("Y-m-d", strtotime($now1)) . " -1 days"));
        $this->line('Yesterday : '. $yesterday.' - '.strtotime($yesterday));
	    ...
	    $unixYesterday = strtotime($yesterday);
